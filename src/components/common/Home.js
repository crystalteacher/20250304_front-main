...
import main_body_bg from "./imgs/main_body_bg.jpg";
  ...
  return (
    <>
      <Container>
            ...
            <BoardBox>
              <BoardTitleBox>
                <div className="titleBox">
                  <BoardTitle>
                    <Link to="/review">진료후기</Link>
                  </BoardTitle>
                  <BoardText>
                    <Link to="/review">직접 치료를 받은 환자가 작성한 생생한 후기</Link>
                  </BoardText>
                </div>
            ...
            <BoardBox>
              <BoardTitleBox>
                <div className="titleBox">
                  ...
                  <BoardText>
                    <Link to="/notice">병원 내부 업무 및 운영에 관한 안내상항</Link>
                  </BoardText>
                </div>
        ...
        <MapContainer>
          <img src={main_body_bg} alt="main_body_bg" width="1920" height="400"></img>
          <SectionD>
            <MapContentBox>
              <div>
                <p className="title">하이펫 동물의료센터</p>
